...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Hermans Glenn">
      ...
      <div class="navbar navbar-default">
          ...
          <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="#"><i class="icon-info"></i> Documantatie</a></li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-globe icon-large"></i> Domeinnamen <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="#">DNS lookup</a></li>
                  <li><a href="#">Reverse dns lookup</a></li>
                  <li class="divider"></li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#">SMTP test</a></li>
                  <li><a href="#">SPAM controle</a></li>
                  <li class="divider"></li>
                  <li class="dropdown-header">Customer tools</li>
                  <li><a href="#">Telenet Webmail</a></li>                  </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-signal icon-large"></i> Netwerk tools <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Ping test</a></li>
                  <li><a href="#">Traceroute</a></li>
                       <li class="divider"></li>
                  <li><a href="#">Server lookup</a></li>
                </ul>
              </li>
            </ul>
          </div><!--/.nav-collapse -->
...
<div class="col-sm-3">
<ul class="list-group">
  <li class="list-group-item"><a href=""><i class="icon-info"></i> Documentatie</a></li>
  <li class="list-group-item"><a href=""><i class="icon-globe"></i> Domeinnamen</a></li>
  <li class="list-group-item"><a href=""><i class="icon-envelope-alt"></i> E-mail</a></li>
  <li class="list-group-item"><a href=""><i class="icon-signal"></i> Netwerk</a></li>
</ul>
